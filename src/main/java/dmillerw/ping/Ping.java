 ...
 * @author dmillerw
 */
@Mod(modid = "Ping", name = "Ping", version = "%MOD_VERSION%", dependencies = "required-after:Forge@[%FORGE_VERSION%,)", acceptedMinecraftVersions = "[1.8.8,1.8.9]", acceptableRemoteVersions = "*", guiFactory = "dmillerw.ping.client.gui.config.PingGuiFactory")
public class Ping {
